...
public class PetMB implements Serializable {
	...
	public void handleFileUpload(FileUploadEvent event) {
		...
		try {
			...
			Logger.getLogger(PetMB.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public String deletePet(Pet pet) {
		...
		logger.log(Level.INFO, "Pet deleted?: " + isDeleted);
		FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Pet Deleted", "Pet Deleted: " + isDeleted);
	...
	public String savePet() {
		...
		tx = null;
		Messages.addInfo("petForm:petPanelGrid", "Pet created succesfully!");
